...
yes, the `build.sh` script **was AI generated**, don't hate me for that.
...
10. Dreamcast audio needs to be synced with the track, (TODO: use `fs_seek()` instead of `SeekMusicStream()`)
