            ...
            void Draw(){
                if(trailSize != 0){
                    if(side == playerSide){
                        ...
                        DrawTextureRec(holdAssets, trailEnd, {pos.x + 28, pos.y + trailSize}, WHITE);
                    }else{
                        DrawTextureRec(holdAssets, {trailRec.x, trailRec.y, trailRec.width, (float)trailSize}, {pos.x - 730 + 28, pos.y + 24}, WHITE);
                        DrawTextureRec(holdAssets, trailEnd, {pos.x - 730 + 28, pos.y + trailSize}, WHITE);
                    }
                }
                if(side == playerSide){
